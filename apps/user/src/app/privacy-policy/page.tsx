...
export const metadata: Metadata = {
  ...
  description:
    'Les om våre retningslinjer for personvern og bruk av informasjonskapsler.',
};
            ...
            <div className="space-y-6">
              <section>
                ...
                <p className="font-[family-name:var(--font-dm-sans)] leading-relaxed text-[var(--baladi-gray)]">
                  ...
                  vårt nettsted. Disse små datafilene lagres på enheten din og
                  hjelper oss med å:
                </p>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="mt-1 font-[family-name:var(--font-dm-sans)] text-sm text-[var(--baladi-gray)]">
                      Disse er essensielle for at nettsiden skal fungere og kan
                      ikke deaktiveres.
                    </p>
                  </div>
                  <div>
              ...
              <div className="bg-[var(--baladi-primary)]/5 mt-8 rounded-lg p-4">
