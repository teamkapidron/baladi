...
export const exportProducts = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    worksheet.columns = [
      ...
      { header: 'Moms', key: 'vat', width: 20 },
      { header: 'Kostpris uten moms', key: 'costPrice', width: 20 },
      { header: 'Salgsverdi uten moms', key: 'salePrice', width: 20 },
      { header: 'Kostpris med moms', key: 'costPriceWithVat', width: 20 },
      { header: 'Salgsverdi med moms', key: 'salePriceWithVat', width: 20 },
...
export const exportOrders = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    worksheet.columns = [
      ...
      { header: 'Produkt moms', key: 'OrderProductVat', width: 20 },
