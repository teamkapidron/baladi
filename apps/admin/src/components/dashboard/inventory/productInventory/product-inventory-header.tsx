...
import AddInventoryDialog from '@/components/dashboard/inventory/add-inventory-dialog/add-inventory-dialog';
      ...
      <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex items-center gap-3">
          <div className="rounded-lg bg-white/10 p-1 backdrop-blur-sm">
            <AddInventoryDialog
              trigger={
                <Button className="group flex h-11 items-center gap-2 rounded-lg bg-white/20 px-4 py-2 font-[family-name:var(--font-dm-sans)] text-sm font-medium text-white backdrop-blur-sm transition-all duration-200 hover:bg-white/30 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-white/40">
